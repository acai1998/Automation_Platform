...
(date('now'), 5, 20, 5, 15, 0, 25.00, 193, 27),
(date('now', '-1 day'), 3, 20, 7, 13, 0, 35.00, 240, 27),
(date('now', '-2 day'), 2, 20, 9, 11, 0, 45.00, 240, 27),
(date('now', '-3 day'), 3, 20, 11, 9, 0, 55.00, 240, 27),
(date('now', '-4 day'), 3, 20, 13, 7, 0, 65.00, 240, 27),
(date('now', '-5 day'), 3, 20, 15, 5, 0, 75.00, 240, 27),
(date('now', '-6 day'), 2, 20, 17, 3, 0, 85.00, 180, 27),
(date('now', '-7 day'), 2, 20, 19, 1, 0, 95.00, 180, 27),
(date('now', '-8 day'), 3, 20, 20, 0, 0, 100.00, 220, 27),
(date('now', '-9 day'), 3, 20, 19, 1, 0, 95.00, 230, 27),
(date('now', '-10 day'), 2, 20, 17, 3, 0, 85.00, 200, 27),
(date('now', '-11 day'), 3, 20, 15, 5, 0, 75.00, 210, 27),
(date('now', '-12 day'), 3, 20, 13, 7, 0, 65.00, 250, 27),
(date('now', '-13 day'), 2, 20, 11, 9, 0, 55.00, 190, 27),
(date('now', '-14 day'), 3, 20, 9, 11, 0, 45.00, 220, 27),
(date('now', '-15 day'), 3, 20, 7, 13, 0, 35.00, 200, 26),
(date('now', '-16 day'), 2, 20, 5, 15, 0, 25.00, 210, 26),
(date('now', '-17 day'), 3, 20, 3, 17, 0, 15.00, 230, 26),
(date('now', '-18 day'), 3, 20, 2, 18, 0, 10.00, 200, 26),
(date('now', '-19 day'), 2, 20, 1, 19, 0, 5.00, 180, 26),
(date('now', '-20 day'), 3, 20, 2, 18, 0, 10.00, 220, 26),
(date('now', '-21 day'), 3, 20, 3, 17, 0, 15.00, 260, 26),
(date('now', '-22 day'), 2, 20, 5, 15, 0, 25.00, 190, 26),
(date('now', '-23 day'), 3, 20, 7, 13, 0, 35.00, 200, 26),
(date('now', '-24 day'), 3, 20, 9, 11, 0, 45.00, 230, 26),
(date('now', '-25 day'), 2, 20, 11, 9, 0, 55.00, 180, 25),
(date('now', '-26 day'), 3, 20, 13, 7, 0, 65.00, 250, 25),
(date('now', '-27 day'), 3, 20, 15, 5, 0, 75.00, 220, 25),
(date('now', '-28 day'), 2, 20, 17, 3, 0, 85.00, 210, 25),
(date('now', '-29 day'), 3, 20, 19, 1, 0, 95.00, 200, 25),
(date('now', '-30 day'), 3, 20, 20, 0, 0, 100.00, 230, 25);
